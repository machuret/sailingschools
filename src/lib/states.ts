...
export type StateRecord = {
  ...
  regions: string[];
  /** City pages that exist today. */
  cities?: { name: string; path: string }[];
};
...
export const states: StateRecord[] = [
  {
    ...
    title: 'Sailing Schools NSW | Sydney, Pittwater & Botany Bay Courses',
    description:
      'Sailing schools across New South Wales — Sydney Harbour, Middle Harbour, Pittwater, Broken Bay and Botany Bay. Beginner sailing, keelboat courses, RYA and IYT yacht training, racing, safety and navigation.',
    waters:
    ...
    cities: [{ name: 'Sydney', path: '/sailing-schools/new-south-wales/sydney/' }],
  },
  {
    key: 'queensland',
    name: 'Queensland',
    title: 'Sailing Schools Queensland | Brisbane, Whitsundays & Sunshine Coast',
    description:
      'Sailing schools in Queensland — Moreton Bay and Brisbane, the Sunshine Coast and Mooloolaba, the Whitsundays and Airlie Beach, and Hervey Bay. Yacht training, catamaran courses and charter preparation.',
    waters:
  ...
  },
  {
    key: 'victoria',
    name: 'Victoria',
    title: 'Sailing Schools Victoria | Melbourne & Port Phillip Sailing Courses',
    description:
      'Sailing schools in Victoria — Melbourne and Port Phillip. Learn to sail, keelboat and yacht training, RYA courses and Yachtmaster preparation on one of Australia’s largest enclosed bays.',
    waters:
  ...
  },
  {
    ...
    title: 'Sailing Schools Perth WA | Fremantle & Geographe Bay Courses',
    description:
      'Sailing schools in Western Australia — Perth, Fremantle, Cockburn Sound, Busselton and Geographe Bay. RYA yacht training, keelboat courses, catamaran sailing and navigation.',
    waters:
  ...
  },
  {
    ...
    description:
      'Sailing schools in Tasmania — Hobart, the Derwent and the D’Entrecasteaux Channel. Learn to sail, yacht training and coastal sailing in demanding southern waters.',
    waters:
